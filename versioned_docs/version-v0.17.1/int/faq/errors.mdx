...
<details open className="details">
  ...
  <details className="details">
    ...
    The issue revolves around an invalid setup or deployment, where keyshares are
    ...
    with the key inside <code>node(num)/validator_keys/keystore-0.json</code>
  </details>
</details>
<details open className="details">
  <summary>
...
<details open className="details">
  ...
  <details className="details">
    ...
    <a href="https://docs.obol.tech/docs/next/int/quickstart/advanced/monitoring">
      Getting Started Monitoring your Node
    </a>{" "}
    in our advanced guides. It does not affect cluster performance or prevent
