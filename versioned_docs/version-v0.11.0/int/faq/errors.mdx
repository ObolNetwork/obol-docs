...
<details open className="details">
  ...
  <details className="details">
    ...
    An ENR is shorthand for an <a href="https://eips.ethereum.org/EIPS/eip-778">
      Ethereum Node Record
    </a>. It is a way to represent a node on a public network, with a reliable mechanism
    ...
    <a href="https://enr-viewer.com/">data contained</a> in their ENR. This
    private key is by default found at{" "}
    <code>.charon/charon-enr-private-key</code>, and should be kept secure, and
...
<details open className="details">
  ...
  <details className="details">
    ...
    <a href="https://github.com/ObolNetwork/charon/issues/960">issue</a> to
...
<details open className="details">
  ...
  <details className="details">
    ...
    This should allow the bootnode enough time to reset your ip/peer limits and
    should then allow new reservations. This could also be due to the bootnode
    being overloaded in general, so reaching a server wide "maximum connections"
    limit. This is an issue with bootnode scalability and we are working in a
...
<details open className="details">
  ...
  <details className="details">
    ...
    . This is not mandatory and should not prevent the cluster from running.
    Only the cluster captain/leader should do this step and resolve this error.
    Check{" "}
...
<details open className="details">
  <summary>
    <h2 id="standalone-bootnode"> Standalone Bootnode </h2>
  </summary>
  <details className="details">
    <summary>
      <h4>
