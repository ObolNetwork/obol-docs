---
sidebar_position: 2
description: Errors & Resolution s
---
...
<details open className="details">
  ...
  <details className="details">
    ...
    <p>
      ...
      sign updates to the [data contained](https://enr-viewer.com/) in their
      ENR. This private key is by default found at{" "}
      <code>.charon/charon-enr-private-key</code>, and should be kept secure,
  ...
  <details className="details">
    ...
    <ul>
      ...
      <li>
        Else, if you are on <code>macOS</code>, press{" "}
        <code>Cmd + Shift + . </code> to view the <code>.charon</code> folder in
...
<details open className="details">
  ...
  <details className="details">
    ...
    This means that Lighthouse is still syncing which will throw a lot of errors
    down the line. Wait for the sync before moving further.
  </details>
  <details className="details">
    <summary>
      <h4>
  ...
  <details className="details">
    ...
    This could be linked to a internet connection being to slow or relying on a
...
<details open className="details">
  ...
  <details className="details">
    ...
    A good quality beacon node API is critical to validator performance. It is
    ...
    [issue](https://github.com/ObolNetwork/charon/issues/960) to mitigate
...
<details open className="details">
  ...
  <details className="details">
    <summary>
      <h4>
        <code>Attester failed in parSigDBThreshold component</code> error
      </h4>
    </summary>{" "}
    Should be fixed in the latest version of Charon, upgrade and restart your
    node.
  </details>
  <details className="details">
    <summary>
      <h4>
        <code>Peer connection failing and dropping</code> error
      </h4>
    </summary>{" "}
    Should be fixed in the latest version of Charon, upgrade and restart your
    node. Likely linked to Obol bootnode infrastructure. You can also try to
    [run your own
    bootnode](https://docs.obol.tech/docs/next/int/quickstart/group/quickstart-group-launchpad#self-host-a-bootnode).
  </details>
  <details className="details">
    <summary>
      <h4>
  ...
  <details className="details">
    ...
    <code>RESERVATION_REFUSED</code> is returned by the bootnode libp2p relay when
    ...
    If stopping your node for 30min doesn't solve <code>
      RESERVATION_REFUSED
    </code>, then it is a problem the Obol team needs to solve.
  </details>
  <details className="details">
    <summary>
      <h4>
...
<details open className="details">
  ...
  <details className="details">
    ...
    the folder <code>.charon/validator_keys</code>. It is caused by an unsafe
    shut down of Teku (usually by double pressing `Ctrl+C` to shutdown
    containers faster).
  </details>
</details>
<details open className="details">
  ...
  <details className="details">
    ...
    Sometimes, grafana dashboard doesn't load any data first time around.You can
  ...
  <details className="details">
    ...
    <a href="https://github.com/ObolNetwork/charon-distributed-validator-node#teku-keystore-file-error">
      Teku Keystore issue
    </a>
    .
  </details>
...
<details open className="details">
  ...
  <details className="details">
    ...
    <p>
      Get the monitoring token and following{" "}
      <a href="https://github.com/ObolNetwork/charon-distributed-validator-node#step-6-leader-adds-central-monitoring-token">
        Step 6 of the quickstart
      </a>
      . This is not mandatory and should not prevent the cluster from running. Only
      the cluster captain/leader should do this step and resolve this error. Check{" "}
      <a href="https://discord.com/channels/849256203614945310/1003921582965674104/1005569855698768066">
        these instructions
      </a>
      from our Discord to get the monitoring token.
    </p>
  </details>
</details>
<details open className="details">
  ...
  <details className="details">
    ...
    <code>CHARON_BEACON_NODE_ENDPOINTS</code> in the
    docker-compose(./docker-compose.yml#84).
  </details>
</details>
<details open className="details">
  <summary>
    <h2> Standalone Bootnode </h2>
  </summary>
  <details className="details">
    <summary>
      <h4>
    ...
    bootnode/docker-compose.yml with your real public IP or DNS hostname.
  </details>
</details>
