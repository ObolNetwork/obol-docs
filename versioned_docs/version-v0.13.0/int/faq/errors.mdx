...
<details open className="details">
  ...
  <details className="details">
    ...
    <a href="/docs/v0.18.0/int/quickstart/group/quickstart-group-operator#step-6---optional-add-the-monitoring-credentials">
      Step 6 of the quickstart
    </a>
    . It does not affect cluster performance or prevent the cluster from
    running.
  </details>
</details>
<details open className="details">
