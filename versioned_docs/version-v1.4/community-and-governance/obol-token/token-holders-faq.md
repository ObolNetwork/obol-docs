---
description: "This page is designed to answer the most common questions from OBOL token holders, particularly those holding liquid OBOL or stOBOL."
sidebar_label: "Token Holders FAQ"
slug: /community-and-governance/obol-token/token-holders-faq
---
...
stOBOL is the liquid staking token received when you stake OBOL. It earns staking rewards and can be used in DeFi. Holding stOBOL in your wallet preserves your governance power. More info in [#staking-and-stobol](staking-and-stobol.md "mention")
...
You receive stOBOL, which maintains your delegation as long as it stays in your wallet. Once transferred (e.g., to a DeFi protocol), you lose the individual delegation. Voting power is then routed via an [auto-delegation strategy](staking-and-stobol.md).&#x20;
