...
<details open className="details">
  ...
  <details className="details">
    ...
    </summary> You can ignore this error unless you have been contacted by the Obol Team with monitoring credentials. In that case, follow <a href="/docs/start/quickstart_group#step-6---optional-add-the-monitoring-credentials">Step 6 of the quickstart</a>. It does not affect cluster performance or prevent the cluster from running.
  </details>
</details>
<details open className="details">
  <summary>
