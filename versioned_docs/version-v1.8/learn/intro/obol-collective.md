...
sidebar_label: "Obol Collective"
slug: /learn/readme/obol-collective
---
...
![](/img/gitbook/DecentralizedOperatorEcosystem.png)
...
* Launchers: Obol's [Charon Distributed Validator Node (CDVN)](../../run-a-dv/start/create-a-dv-with-a-group.mdx), Obol's Distributed Validator Pod.
* Rewards: [Obol Splits](obol-splits.md), a set of solidity smart contracts for the distribution of rewards from Distributed Validators, amongst multiple node operations.
