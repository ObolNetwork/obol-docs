...
The following is a reference for Charon version [`v1.9.0-rc3`](https://github.com/ObolNetwork/charon/releases/tag/v1.9.0-rc3). Find the latest release on [our Github](https://github.com/ObolNetwork/charon/releases).
