...
## Optimistic Withdrawal Recipient[​](obol-splits.md#optimistic-withdrawal-recipient) {#optimistic-withdrawal-recipient}
...
## Split Contracts[​](obol-splits.md#split-contracts) {#split-contracts}
...
### Split Controllers[​](obol-splits.md#split-controllers) {#split-controllers}
...
#### (Gnosis) SAFE wallet[​](obol-splits.md#gnosis-safe-wallet) {#gnosis-safe-wallet}
