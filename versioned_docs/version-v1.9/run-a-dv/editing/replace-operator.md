---
description: "Replace an operator in your existing distributed validator cluster using the charon alpha edit replace-operator command."
sidebar_label: "Replace an Operator"
slug: /run-a-dv/editing/replace-operator
---
