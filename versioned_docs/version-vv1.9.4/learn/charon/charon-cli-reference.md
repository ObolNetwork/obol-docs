...
The following is a reference for Charon version [`v1.9.4`](https://github.com/ObolNetwork/charon/releases/tag/v1.9.4). Find the latest release on [our Github](https://github.com/ObolNetwork/charon/releases).
