---
sidebar_label: "Charon Networking"
...
### Internal Validator Stack<a id="internal-validator-stack"></a> {#internal-validator-stack}
![Diagram of Charon&#x27;s internal validator stack networking — local connections between Charon, the execution client, consensus client, and validator client.](/img/gitbook/image-22.png)
...
### External P2P Network<a id="external-p2p-network"></a> {#external-p2p-network}
![Diagram of Charon&#x27;s external peer-to-peer network — relay-assisted peer discovery and direct TCP connections between cluster nodes.](/img/gitbook/image-23.png)
...
#### LibP2P Authentication and Security<a id="libp2p-authentication-and-security"></a> {#libp2p-authentication-and-security}
...
#### LibP2P Relays and Peer Discovery<a id="libp2p-relays-and-peer-discovery"></a> {#libp2p-relays-and-peer-discovery}
...
#### Scalable Relay Clusters<a id="scalable-relay-clusters"></a> {#scalable-relay-clusters}
