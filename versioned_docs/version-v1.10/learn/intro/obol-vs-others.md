...
sidebar_label: "Obol vs Other DV Implementations"
slug: /learn/readme/obol-vs-others
---
...
![Diagram contrasting Obol&#x27;s distributed validator architecture with alternative DV approaches.](/img/gitbook/image-8-1-1.png)
...
![Diagram showing Obol DV clusters communicating directly via LibP2P, with each cluster upgradeable independently.](/img/gitbook/image-9-1-1.png)
...
![Diagram showing Charon operating alongside an existing validator client and existing validator keys.](/img/gitbook/image-10-1-1.png)
...
![Diagram of Obol Splits distributing ETH validator rewards among operators without requiring a custom token.](/img/gitbook/image-11-1-1.png)
...
![Diagram of an alternative DV design that requires a native network token to pay operators.](/img/gitbook/image-12-1-1.png)
...
![Diagram of the non-custodial reward-split flow from the validator&#x27;s withdrawal address to operator and principal addresses.](/img/gitbook/image-13-1-1.png)
