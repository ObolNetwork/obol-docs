---
sidebar_label: "For Node Operators"
slug: /run-a-dv/integrations/lido-v3-stvault-integration-kit/lido-v3-stvault-for-node-operator
---
...
![Screenshot of the Splits.org UI configuring split recipients — 5% of stVault fees routed to a chosen address.](/img/gitbook/SPLITS-UI-RECIPIENTS.png)
...
![Diagram of the Lido stVault setup overview, showing the relationship between vault, operators, and capital allocator.](/img/gitbook/LIDO-STVAULT-OVERVIEW.png)

![Screenshot of the DV Launchpad&#x27;s custom withdrawal configuration form for a Lido stVault deployment.](/img/gitbook/CUSTOM-WITHDRAWAL-CONFIG.png)
