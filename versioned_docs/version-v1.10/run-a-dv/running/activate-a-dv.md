---
description: "Learn how to activate your distributed validator cluster using the new deposit flow with support for compounding validators and OVM integration."
...
![Screenshot of the DV activation flow indicating that OVM users must use the DEPOSIT_ROLE wallet to perform deposits.](/img/gitbook/OVMDeposit1.png)
...
![Screenshot of the OVM allocation and submission step in the activation flow.](/img/gitbook/OVMDeposit3.png)

![Screenshot of the OVM allocation summary in the activation flow.](/img/gitbook/OVMDeposit4.png)
...
![Screenshot of the OVM principal adjustment interface in the activation flow.](/img/gitbook/OVMDeposit5.png)
