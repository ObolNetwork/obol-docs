...
sidebar_label: "Monitoring Your Node"
slug: /run-a-dv/running/monitoring
---
...
2.  Click on `+ Add contact point`. It will show the following page. Choose Discord in the `Integration` drop down.
    ...
    ![Screenshot: Click on + Add contact point. It will show the following page. Choose Discord in the Integration drop down.](/img/gitbook/image-26.png)
