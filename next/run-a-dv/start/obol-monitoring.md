...
2.  Navigate to your Obol package in DappNode and go to the Config tab.
    ...
    ![Screenshot: Navigate to your Obol package in DappNode and go to the Config tab.](/img/gitbook/image-85.png)
...
4.  Return to the **Info** tab, scroll down to the Containers section, and click the down arrow to view all container statuses. If the Prometheus container is stopped, please restart it.
    ...
    ![Screenshot: Return to the Info tab, scroll down to the Containers section, and click the down arrow to view all container statuses. If the Prometheus container is stopped, please restart it.](/img/gitbook/image-86.png)
</TabItem>
