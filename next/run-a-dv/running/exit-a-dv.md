...
![Screenshot of the EL-triggered exit interface on the DV Launchpad.](/img/gitbook/Screenshot-2026-02-11-at-16.46.19.png)
...
![Screenshot of the multi-select validator exit interface on the DV Launchpad.](/img/gitbook/Screenshot-2026-02-11-at-16.59.40.png)
...
![Screenshot of the EL exit confirmation page on the DV Launchpad.](/img/gitbook/Screenshot-2026-02-11-at-17.01.17.png)
...
![Screenshot of the EL exit completion page showing the validator&#x27;s final balance.](/img/gitbook/ElExit4.png)

![Screenshot of the EL exit confirmation displaying the validator&#x27;s exit transaction.](/img/gitbook/ElExit5.png)

![Screenshot of the EL exit completion summary on the DV Launchpad.](/img/gitbook/ElExit6.png)
...
![Screenshot: After a threshold of signed partial exits from node operators in the cluster is accumulated, a full (complete) exit can be created. For example, in the cluster below, only 2 out…](/img/gitbook/image-1.png)
...
1.  Operator 1 broadcasts an exit on validator client 1.
    ...
    ![Screenshot: Operator 1 broadcasts an exit on validator client 1.](/img/gitbook/image-1-1.png)

    ![Screenshot: Operator 1 broadcasts an exit on validator client 1.](/img/gitbook/image-2.png)
2.  Operator 2 broadcasts an exit on validator client 2.

    ![Screenshot: Operator 2 broadcasts an exit on validator client 2.](/img/gitbook/image-4.png)

    ![Screenshot: Operator 2 broadcasts an exit on validator client 2.](/img/gitbook/image-5.png)
3.  Operator 3 broadcasts an exit on validator client 3.

    ![Screenshot: Operator 3 broadcasts an exit on validator client 3.](/img/gitbook/image-6.png)

    ![Screenshot: Operator 3 broadcasts an exit on validator client 3.](/img/gitbook/image-7.png)
...
![Screenshot: At this point, the threshold of 3 has been reached and the validator exit process will start. The logs will show the following.](/img/gitbook/image-8.png)
...
1.  Operator 1 broadcasts an exit on validator client 1.
    ...
    ![Prometheus query graph showing operator 1 broadcasting an exit on its validator client.](/img/gitbook/ExitPromQuery-01.png)

    ![Charon log showing operator 1&#x27;s partial exit signature.](/img/gitbook/DutyExit-01.png)
2.  Operator 2 broadcasts an exit on validator client 2.

    ![Prometheus query graph showing operator 2 broadcasting an exit on its validator client.](/img/gitbook/ExitPromQuery-02.png)

    ![Charon log showing operator 2&#x27;s partial exit signature.](/img/gitbook/DutyExit-02.png)
3.  Operator 3 broadcasts an exit on validator client 3.

    ![Prometheus query graph showing operator 3 broadcasting an exit on its validator client.](/img/gitbook/ExitPromQuery-03.png)

    ![Charon log showing operator 3&#x27;s partial exit signature.](/img/gitbook/DutyExit-03.png)

At this point, the threshold of 3 has been reached and the validator exit process will start. The logs will show the following:

![Charon log showing the cluster reaching the exit-signature threshold and broadcasting the aggregated exit.](/img/gitbook/ExitLogs.png)
...
1.  Operator 1 broadcasts an exit on validator client 1.
    ...
    ![Screenshot: Operator 1 broadcasts an exit on validator client 1.](/img/gitbook/image-9.png)

    ![Screenshot: Operator 1 broadcasts an exit on validator client 1.](/img/gitbook/image-10.png)
2.  Operator 2 broadcasts an exit on validator client 2.

    ![Screenshot: Operator 2 broadcasts an exit on validator client 2.](/img/gitbook/image-11.png)

    ![Screenshot: Operator 2 broadcasts an exit on validator client 2.](/img/gitbook/image-12.png)
3.  Operator 3 broadcasts an exit on validator client 3.

    ![Screenshot: Operator 3 broadcasts an exit on validator client 3.](/img/gitbook/image-13.png)

    ![Screenshot: Operator 3 broadcasts an exit on validator client 3.](/img/gitbook/image-14.png)

At this point, the threshold of 3 has been reached and the validator exit process will start. The logs will show the following:

![Screenshot: At this point, the threshold of 3 has been reached and the validator exit process will start. The logs will show the following.](/img/gitbook/image-15.png)
...
1.  Navigate to the config tab of your Obol DappNode package. Click 'Packages', then click 'My Packages', and enter the Obol package. Go to the config tab. At the bottom right corner of the page, click on 'Show Advanced Editor'.
    ...
    ![Screenshot: Navigate to the config tab of your Obol DappNode package. Click &#x27;Packages&#x27;, then click &#x27;My Packages&#x27;, and enter the Obol package. Go to the config tab. At the bottom right corner…](/img/gitbook/image-17.png)
2.  The advanced editor config page provides ENV configs for each validator. Scroll to the validator number you want to exit and type “true” in the column opposite SIGN\_EXIT.
    ...
    ![Screenshot: The advanced editor config page provides ENV configs for each validator. Scroll to the validator number you want to exit and type “true” in the column opposite SIGNEXIT.](/img/gitbook/image-18.png)
3.  Scroll to the bottom of the page and click the 'update' button for the changes to take effect.

    ![Screenshot: Scroll to the bottom of the page and click the &#x27;update&#x27; button for the changes to take effect.](/img/gitbook/image-19.png)
...
![Screenshot of the DV Launchpad showing partial exit signatures collected from a threshold of operators.](/img/gitbook/PartialExitsStatus.png)
...
1.  Navigate to the config tab of your Obol DappNode package. Click 'Packages', then click 'My Packages', and enter the Obol package. Go to the config tab. At the bottom right corner of the page, click on 'Show Advanced Editor'.
    ...
    ![Screenshot of the DappNode config tab for the Obol package.](/img/gitbook/ConfigTabExit.png)
2.  The advanced editor config page provides ENV configs for each validator. Scroll to the validator number you want to exit and type “true” in the column opposite SIGN\_EXIT.

    ![Screenshot of the DappNode advanced editor with EXIT_VALIDATOR set to true.](/img/gitbook/TypeTrue.png)
3.  Scroll to the bottom of the page and click the 'update' button for the changes to take effect.

    ![Screenshot of the DappNode &#x27;update&#x27; button used to apply the validator-exit config change.](/img/gitbook/ExitUpdate.png)
4. Check your logs to confirm the exit process has started.
...
### Other Charon exit commands {#other-charon-exit-commands}
