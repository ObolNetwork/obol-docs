...
The `charon-enr-private-key` **must be preserved**, failure in doing so requires the DKG process to be started from scratch by creating a new cluster definition.
