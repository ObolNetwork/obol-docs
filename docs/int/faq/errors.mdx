...
<details open className="details">
  <summary>
    ...
    <details className="details">
      ...
      Likely linked to Obol bootnode infrastructure. 
      You can also try to <a href="https://docs.obol.tech/docs/next/int/quickstart/group/quickstart-group-launchpad#self-host-a-bootnode">run your own bootnode</a>.
    </details>
    <details className="details">
      <summary>
        <h4>
    ...
    <details className="details">
      ...
      This should allow the bootnode enough time to reset your ip/peer limits and should then allow new reservations. 
      This could also be due to the bootnode being overloaded in general, so reaching a server wide "maximum connections" limit.
      This is an issue with bootnode scalability and we are working in a long term fix for this. 
    </details>
    <details className="details">
      <summary>
        <h4>
