...
<details open className="details">
  ...
  <details className="details">
    ...
    </summary> You can ignore this error unless you have been contacted by the Obol Team with monitoring credentials. In that case, follow <a href="/docs/int/quickstart/advanced/monitoring-credentials">Getting Started Monitoring your Node</a> in our advanced guides. It does not affect cluster performance or prevent the cluster from running.
  </details>
</details>
<details open className="details">
  <summary>
