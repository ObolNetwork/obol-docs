...
:::warning Note that you should proceed only if you accept the risk and have tested this on goerli testnet.
...
2. If you have already cloned the repo, make sure that it is [up-to-date](https://github.com/ObolNetwork/obol-docs/blob/main/versioned_docs/version-v0.15.0/int/quickstart/quickstart-alone/README.md#updating-dv-stack).
