...
5.  Configure the Cluster
    ...
    * Input the Ethereum addresses for each operator received at the end of [Step 1](quickstart-group-launchpad.md#step-1-creating-and-backing-up-a-private-key-for-charon).
