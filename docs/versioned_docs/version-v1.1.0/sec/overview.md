...
* A review of Obol Labs [development processes](https://github.com/ObolNetwork/obol-docs/blob/main/versioned_docs/version-v1.1.0/sec/ev-assessment/README.md) by [Ethereal Ventures](https://www.etherealventures.com/).
...
* A [solidity audit](https://github.com/ObolNetwork/obol-docs/blob/main/versioned_docs/version-v1.1.0/sec/smart_contract_audit/README.md) of the Obol Splits contracts by [Zach Obront](https://zachobront.com/).
...
* A [threat model](https://github.com/ObolNetwork/obol-docs/blob/main/versioned_docs/version-v1.1.0/sec/threat_model/README.md) for a DV middleware client like Charon.
