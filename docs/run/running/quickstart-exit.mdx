        ...
        **Step 1: submit partial exit for all active validators**
        <Tabs groupId="nimbus-single-all">
            <TabItem value="nimbus-single" label="Single Validator" default>
                ...
                The directories referenced here (and their subdirectories related to the node) originate from the mapping in CDVC (note: CDVC isn't ideal as the vc-nimbus container applies to both 2 and 5).
                If you've customized your volume mappings, the directory structure may not align with the defaults mentioned here. Ensure your mappings are consistent with your configuration for seamless integration.
