...
* [Solidity](https://github.com/ObolNetwork/obol-docs/blob/main/docs/learn/intro/obol-splits.mdx): Withdrawal and fee recipient contracts for use with distributed validators.
