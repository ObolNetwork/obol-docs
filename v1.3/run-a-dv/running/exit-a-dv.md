...
### Introduction[​](https://docs.obol.org/next/run/running/quickstart-exit#introduction) {#introduction}
...
#### Step 1: Submit partial exit {#introduction}
<Tabs>
...
![](/img/gitbook/spaces_XeyaDcGpivHZJ18c2xxu_uploads_git-blob-9d5df062b767cf6cefe35e34437b25b1a0104f47_image-1.png)
...
### Exit epoch and withdrawable epoch[​](https://docs.obol.org/next/run/running/quickstart-exit#exit-epoch-and-withdrawable-epoch) {#exit-epoch-and-withdrawable-epoch}
